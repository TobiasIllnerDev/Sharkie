...
const INITIAL_IMAGE_ASSETS = [
    ...
    ...range(13, i => `./assets/img/Sharkie/2.Long_IDLE/I${i + 1}.png`),
    ...
    ...range(2, i => `./assets/img/Marcadores/green/Life/${i}_Lifebar.png`),
    ...range(4, i => `./assets/img/Marcadores/green/Life/${i + 2}_lifebar.png`),
